<?php
/**
 * LegacyCombinedListingHandler
 */
namespace TMG\Api\LegacyBundle\Handler;

use Proxies\__CG__\TMG\Api\LegacyBundle\Entity\Address;
use TMG\Api\ApiBundle\Handler\ApiHandler;

class LegacyAddressHandler extends ApiHandler
{
    /**
     * @param $lat
     * @param $long
